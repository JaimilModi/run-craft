...
function LanguageSelector({ hasAccess }: { hasAccess: boolean }) {
  ...
  if (!motion) return null; //tere liye...
      ...
      <AnimatePresence mode="wait">
        {showUpgrade && (
          <motion.div
            ...
            className="absolute top-[110%] left-1/2 -translate-x-1/2 z-[60]"
          >
            <div
              className="bg-[#1e1e2e]/95 backdrop-blur-xl border border-[#313244] 
        rounded-xl px-5 py-4 shadow-2xl w-[320px]"
            >
            ...
            p-2 rounded-lg"
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Upgrade to Pro to access 10+ languages including C, C++,
                    Java, Rust and more.
                  </p>
                </div>
              </div>
